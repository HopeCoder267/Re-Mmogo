...
export default function MemberEnrollmentPage() {
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-10 max-w-md w-full text-center">
            ...
            <p className="text-gray-500 mb-6">
              The new member has been enrolled and is pending admin approval
              before appearing in the group table.
            </p>
  ...
  return (
    <ProtectedRoute permissionKey="enroll-member">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Register a new member into the RE-MMOGO savings group
                </p>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <select
                      {...register("contributionDay", {
                        required: "Please select a contribution day",
                      })}
                      className={`w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e1b4b] transition bg-white ${
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    {...register("declaration", {
                      required: "Declaration must be acknowledged",
                    })}
                    type="checkbox"
                  ...
                  <span className="text-sm text-gray-700">
                    ...
                    this member agrees to abide by the{" "}
                    <span className="text-[#10b981] font-semibold">
                      RE-MMOGO group rules
                    </span>
                    , including monthly contributions of P1,000 and the
                    collective savings goal of P5,000.
                  </span>
                </label>
                {errors.declaration && (
